...
pub const CONFIG_SOC_GPIO_FILTER_CLK_SUPPORT_XTAL: u32 = 1;
pub const CONFIG_SOC_GPIO_FILTER_CLK_SUPPORT_PLL_F80M: u32 = 1;
...
pub const CONFIG_SOC_LEDC_GAMMA_FADE_RANGE_MAX: u32 = 16;
...
pub const CONFIG_SOC_RMT_SUPPORT_PLL_F80M: u32 = 1;
...
pub const CONFIG_SOC_MCPWM_CLK_SUPPORT_XTAL: u32 = 1;
...
pub const CONFIG_SOC_TIMER_GROUP_SUPPORT_PLL_F80M: u32 = 1;
...
pub const CONFIG_IDF_TARGET: &[u8; 8usize] = b"esp32c6\0";
...
pub const ESP_CSI_ACQUIRE_STBC_HELTF1: crate::c_types::c_uint = 0;
#[doc = "< HE STBC: select the second HE-LTF"]
pub const ESP_CSI_ACQUIRE_STBC_HELTF2: crate::c_types::c_uint = 1;
#[doc = "< HE STBC: sample alternating scarier of HE-LTF1 and HE-LTF2"]
pub const ESP_CSI_ACQUIRE_STBC_SAMPLE_HELTFS: crate::c_types::c_uint = 2;
...
#[doc = "2) timeout of receiving probe response in response of previously probe request sending by station"]
