...
#[doc = "!< Callback is called from timer ISR"]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " This only works for a timer that has an ISR dispatch method."]
    #[doc = " The context switch will be called after all ISR dispatch timers have been processed."]
