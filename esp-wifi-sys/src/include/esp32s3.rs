...
pub const ESP_BT_CTRL_CONFIG_VERSION: u32 = 37765136;
...
#[doc = " @brief type of BLE connection event length computation"]
...
pub struct esp_bt_controller_config_t {
    ...
    #[doc = "< maximum number of duplicate scan filter"]
    ...
    #[doc = "< Hardware re-correction enabled"]
    ...
    #[doc = "< BLE CCA mode"]
    pub ble_cca_mode: u8,
    #[doc = "< Config ext adv aux option"]
    pub ble_data_lenth_zero_aux: u8,
    #[doc = "< BLE channel assessment enable"]
    pub ble_chan_ass_en: u8,
    #[doc = "< BLE ping procedure enable"]
    pub ble_ping_en: u8,
}
