...
pub const CONFIG_SOC_USB_OTG_CONSOLE_SUPPORTED: u32 = 1;
...
pub const CONFIG_SOC_CACHE_ACS_INVALID_STATE_ON_PANIC: u32 = 1;
...
pub const CONFIG_SOC_USB_FSLS_PHY_NUM: u32 = 1;
...
pub const CONFIG_SOC_SPI_MEM_SUPPORT_FLASH_OPI_MODE: u32 = 1;
...
pub const CONFIG_SOC_MEMSPI_SUPPORT_CONTROL_DUMMY_OUT: u32 = 1;
...
pub const CONFIG_BT_BLE_HOST_ALLOW_SUB_SPEC_MIN_CONN_INT: u32 = 1;
...
pub const CONFIG_BT_CTRL_CHECK_CONFIG_EFF: u32 = 1;
...
pub const CONFIG_BT_CTRL_PINNED_TO_CORE_0: u32 = 1;
...
pub const CONFIG_BT_BLE_CCA_MODE_NONE: u32 = 1;
pub const CONFIG_BT_BLE_CCA_MODE: u32 = 0;
pub const CONFIG_BT_CTRL_HW_CCA_VAL: u32 = 75;
...
pub const CONFIG_BT_CTRL_CHAN_ASS_EN: u32 = 1;
pub const CONFIG_BT_CTRL_LE_PING_EN: u32 = 1;
pub const CONFIG_BT_CTRL_DTM_ENABLE: u32 = 1;
pub const CONFIG_BT_CTRL_BLE_MASTER: u32 = 1;
pub const CONFIG_BT_CTRL_BLE_SCAN: u32 = 1;
pub const CONFIG_BT_CTRL_BLE_SECURITY_ENABLE: u32 = 1;
pub const CONFIG_BT_CTRL_BLE_ADV: u32 = 1;
pub const CONFIG_BT_CTRL_BLE_MIN_CONN_INTERVAL_ENABLE: u32 = 1;
...
pub const CONFIG_PM_RESTORE_CACHE_TAGMEM_AFTER_LIGHT_SLEEP: u32 = 1;
...
pub const CONFIG_ESP_SYSTEM_MEMPROT_PMS: u32 = 1;
pub const CONFIG_ESP_SYSTEM_MEMPROT_PMS_LOCK: u32 = 1;
...
pub const CONFIG_ESP32S3_DEFAULT_CPU_FREQ_160: u32 = 1;
pub const CONFIG_ESP32S3_DEFAULT_CPU_FREQ_MHZ: u32 = 160;
...
pub const _SOC_CAPS_TARGET_IS_ESP32S3: u32 = 1;
...
pub const SOC_USB_OTG_CONSOLE_SUPPORTED: u32 = 1;
...
pub const SOC_APPCPU_HAS_CLOCK_GATING_BUG: u32 = 1;
...
pub const SOC_ADC_PATT_LEN_MAX: u32 = 24;
...
pub const SOC_CACHE_ACS_INVALID_STATE_ON_PANIC: u32 = 1;
...
pub const SOC_GPIO_IN_RANGE_MAX: u32 = 48;
pub const SOC_GPIO_OUT_RANGE_MAX: u32 = 48;
pub const SOC_GPIO_VALID_DIGITAL_IO_PAD_MASK: u64 = 562949886312448;
...
pub const SOC_RTC_CNTL_CPU_PD_REG_FILE_NUM: u32 = 549;
...
pub const SOC_USB_FSLS_PHY_NUM: u32 = 1;
...
pub const SOC_PM_CPU_RETENTION_BY_RTCCNTL: u32 = 1;
pub const SOC_PM_MODEM_RETENTION_BY_BACKUPDMA: u32 = 1;
...
pub const SOC_MEMPROT_MEM_ALIGN_SIZE: u32 = 256;
...
pub const SOC_SPI_MEM_SUPPORT_FLASH_OPI_MODE: u32 = 1;
...
pub const SOC_MEMSPI_CORE_CLK_SHARED_WITH_PSRAM: u32 = 1;
pub const SOC_SPI_MEM_SUPPORT_CACHE_32BIT_ADDR_MAP: u32 = 1;
pub const SOC_SPI_MEM_FLASH_SUPPORT_HPM: u32 = 1;
pub const SOC_MEMSPI_SUPPORT_CONTROL_DUMMY_OUT: u32 = 1;
...
pub const SOC_SDMMC_DELAY_PHASE_NUM: u32 = 4;
...
pub const SOC_WIFI_PHY_NEEDS_USB_WORKAROUND: u32 = 1;
...
pub const ESP_BT_CTRL_CONFIG_VERSION: u32 = 38834816;
...
pub const BT_CTRL_AGC_RECORRECT_NEW: u32 = 0;
pub const BT_CTRL_CODED_AGC_RECORRECT: u32 = 0;
pub const BT_CTRL_50_FEATURE_SUPPORT: u32 = 1;
pub const BT_BLE_CCA_MODE: u32 = 0;
pub const BT_BLE_ADV_DATA_LENGTH_ZERO_AUX: u32 = 0;
pub const BT_CTRL_CHAN_ASS_EN: u32 = 1;
pub const BT_CTRL_LE_PING_EN: u32 = 1;
pub const AGC_RECORRECT_EN: u32 = 0;
pub const CFG_MASK_BIT_SCAN_DUPLICATE_OPTION: u32 = 1;
pub const CFG_MASK: u32 = 1;
pub const BLE_HW_TARGET_CODE_CHIP_ECO0: u32 = 33619968;
pub const BT_CTRL_BLE_LLCP_CONN_UPDATE: u32 = 0;
pub const BT_CTRL_BLE_LLCP_CHAN_MAP_UPDATE: u32 = 0;
pub const BT_CTRL_BLE_LLCP_PHY_UPDATE: u32 = 0;
pub const BT_CTRL_BLE_LLCP_DISC_FLAG: u32 = 0;
pub const BT_CTRL_RUN_IN_FLASH_ONLY: u32 = 0;
pub const BT_CTRL_DTM_ENABLE: u32 = 1;
pub const BT_CTRL_BLE_MASTER: u32 = 1;
pub const BT_CTRL_BLE_TEST: u32 = 0;
pub const BLE_SECURITY_ENABLE: u32 = 1;
pub const BT_CTRL_BLE_SCAN: u32 = 1;
pub const BT_CTRL_BLE_ADV: u32 = 1;
pub const BLE_CTRL_CHECK_CONNECT_IND_ACCESS_ADDRESS_ENABLED: u32 = 0;
pub const BT_BLE_LOG_EN: u32 = 0;
pub const BLE_LOG_MODE_EN: u32 = 0;
pub const BLE_LOG_LEVEL: u32 = 0;
...
#[doc = " @brief Bluetooth modem sleep clock source\n\n @note If the modem sleep mode is enabled, `ESP_BT_SLEEP_CLOCK_MAIN_XTAL` is the default option and\n      `ESP_BT_SLEEP_CLOCK_NONE` will become an invalid option."]
pub type esp_bt_sleep_clock_t = crate::c_types::c_uint;
#[doc = "< Antenna NO 0"]
pub const ESP_BT_ANT_IDX_0: _bindgen_ty_1 = 0;
#[doc = "< Antenna NO 1"]
pub const ESP_BT_ANT_IDX_1: _bindgen_ty_1 = 1;
#[doc = " @brief Bluetooth antenna index"]
pub type _bindgen_ty_1 = crate::c_types::c_uint;
#[doc = "< Disable the limit"]
pub const ESP_BT_COEX_PHY_CODED_TX_RX_TIME_LIMIT_FORCE_DISABLE: _bindgen_ty_2 = 0;
#[doc = "< Enable the limit"]
pub const ESP_BT_COEX_PHY_CODED_TX_RX_TIME_LIMIT_FORCE_ENABLE: _bindgen_ty_2 = 1;
#[doc = " @brief Enable / disable the maximum TX/RX time limit for Coded-PHY connections in coexistence with Wi-Fi scenarios"]
...
pub struct esp_bt_hci_tl_t {
    ...
    >,
    #[doc = "< HCI transport layer send function"]
    ...
    >,
    #[doc = "< HCI transport layer flow off function"]
    pub _flow_off: ::core::option::Option<unsafe extern "C" fn() -> bool>,
    #[doc = "< HCI transport layer flow on function"]
...
pub struct esp_bt_controller_config_t {
    ...
    #[doc = "< CPU number that Bluetooth Controller task runs on. Configurable in menuconfig.\n- 0 - CPU 0 (default)\n- 1 - CPU 1"]
    pub controller_task_run_cpu: u8,
    #[doc = "< BLE mode"]
    pub bluetooth_mode: u8,
    #[doc = "< The maximum number of BLE instance. Configurable in menuconfig.\n- Range: 1 - 10\n- Default: 6"]
    pub ble_max_act: u8,
    #[doc = "< Modem sleep mode. Configurable in menuconfig.\n- 0 - Disable (default)\n- 1 - Enable"]
    pub sleep_mode: u8,
    #[doc = "< Modem sleep clock source. Configurable in menuconfig."]
    pub sleep_clock: u8,
    #[doc = "< Static ACL TX buffer numbers. Configurable in menuconfig.\n- Range: 0 - 12\n- Default: 0"]
    pub ble_st_acl_tx_buf_nb: u8,
    #[doc = "< Deprecated"]
    pub ble_hw_cca_check: u8,
    #[doc = "< The maximum number of extended duplicate scan filter. Configurable in menuconfig.\n- Range: 1 - 500\n- Default: 30"]
    pub ble_adv_dup_filt_max: u16,
    #[doc = "< Deprecated"]
    pub coex_param_en: bool,
    #[doc = "< Connection event length determination method. Configurable in menuconfig.\n- 0 - Original (default)\n- 1 - use `CE_LEN` parameter from HCI commands\n- 2 - Espressif vendor defined method"]
    pub ce_len_type: u8,
    #[doc = "< Deprecated"]
    pub coex_use_hooks: bool,
    #[doc = "< HCI transport layer type. Configurable in menuconfig.\n- 0 - URAT\n- 1 - Virtual HCI (default)"]
    pub hci_tl_type: u8,
    #[doc = "< HCI transport functions used. It must be set when `hci_tl_type` is UART."]
    pub hci_tl_funcs: *mut esp_bt_hci_tl_t,
    #[doc = "< Default TX antenna. Configurable in menuconfig.\n- 0 - Antenna 0 (default)\n- 1 - Antenna 1"]
    pub txant_dft: u8,
    #[doc = "< Default RX antenna. Configurable in menuconfig.\n- 0 - Antenna 0 (default)\n- 1 - Antenna 1"]
    pub rxant_dft: u8,
    #[doc = "< Default TX power. Please refer to `esp_power_level_t` for supported power level. Configurable in menuconfig.\n- Default : `ESP_PWR_LVL_P9` +9 dBm."]
    pub txpwr_dft: u8,
    #[doc = "< Configuration mask to set specific options"]
    pub cfg_mask: u32,
    ...
    #[doc = "< Enable / disable the maximum TX/RX time limit for Coded-PHY connections in coexistence with Wi-Fi scenarios. Configurable in menuconfig.\n- 0 - Disable (default)\n- 1 - Enable"]
    pub coex_phy_coded_tx_rx_time_limit: u8,
    #[doc = "< Hardware target. Internal use only. Please do not modify this value."]
    pub hw_target_code: u32,
    #[doc = "< Slave minimum connection event length: 5 slots. Please do not modify this value."]
    pub slave_ce_len_min: u8,
    #[doc = "< Enable / disable uncoded phy / coded phy hardware re-correction. Configurable in menuconfig."]
    pub hw_recorrect_en: u8,
    #[doc = "< Absolute value of hardware-triggered CCA threshold. The CCA threshold is always negative.\nIf the channel assessment result exceeds the CCA threshold (e.g. -75 dBm), indicating the channel is busy,\nthe hardware will not transmit packets on that channel. Configurable in menuconfig.\n- Range: 20 dBm - 100 dBm\n- Default: 75 dBm"]
    pub cca_thresh: u8,
    #[doc = "< Enable / disable active scan backoff. Configurable in menuconfig.\n- 0 - Disable (default)\n- 1 - Enable"]
    ...
    #[doc = "< True if BLE 5.0 features are enabled; false otherwise. This option depends on whether the Host enable the 5.0 features."]
    pub ble_50_feat_supp: bool,
    #[doc = "< BLE CCA mode. Configurable in menuconfig\n- 0 - Disable (default)\n- 1 - Hardware-triggered CCA\n- 2 - Software-based CCA (experimental)"]
    pub ble_cca_mode: u8,
    ...
    #[doc = "< Enable / disable BLE ping procedure. Configurable in menuconfig.\n- 0 - Disable\n- 1 - Enable (default)"]
    pub ble_ping_en: u8,
    ...
    #[doc = "< True if the Controller code is in flash (flash model); false otherwise (default). Configurable in menuconfig."]
    pub run_in_flash: bool,
    #[doc = "< True if the DTM feature is enabled; false otherwise (default). Configurable in menuconfig."]
    pub dtm_en: bool,
    #[doc = "< True if the encryption feature is enabled (default); false otherwise. Configurable in menuconfig."]
    pub enc_en: bool,
    #[doc = "< True if the QA test feature is enabled; false otherwise (default). Configurable in menuconfig."]
    pub qa_test: bool,
    #[doc = "< True if the connection feature is enabled (default); false otherwise. Configurable in menuconfig."]
    pub connect_en: bool,
    #[doc = "< True if the scan feature is enabled (default); false otherwise. Configurable in menuconfig."]
    pub scan_en: bool,
    ...
    #[doc = "< True if the ADV feature is enabled (default); false otherwise. Configurable in menuconfig."]
    pub adv_en: bool,
}
...
pub struct esp_vhci_host_callback {
    ...
    #[doc = "< callback used to notify that the Controller has the HCI data to send to the Host"]
...
extern "C" {
    pub fn esp_ble_controller_log_dump_all(output: bool);
}
...
pub const ESP_CSI_ACQUIRE_STBC_HELTF1: _bindgen_ty_3 = 0;
#[doc = "< HE STBC: select the second HE-LTF"]
pub const ESP_CSI_ACQUIRE_STBC_HELTF2: _bindgen_ty_3 = 1;
#[doc = "< HE STBC: sample alternating scarier of HE-LTF1 and HE-LTF2"]
pub const ESP_CSI_ACQUIRE_STBC_SAMPLE_HELTFS: _bindgen_ty_3 = 2;
