...
#define CONFIG_SOC_MODEM_CLOCK_BLE_RTC_TIMER_WORKAROUND 1
...
#define CONFIG_ESP32H2_UNIVERSAL_MAC_ADDRESSES_ONE 1
#define CONFIG_ESP32H2_UNIVERSAL_MAC_ADDRESSES 1
