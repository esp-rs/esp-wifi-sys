...
pub const CONFIG_SDK_TOOLPREFIX: &[u8; 18usize] = b"xtensa-esp32-elf-\0";
...
pub const CONFIG_BT_CTRL_ESP32: u32 = 1;
...
pub const CONFIG_TOOLPREFIX: &[u8; 18usize] = b"xtensa-esp32-elf-\0";
...
pub const NORMAL_SCAN_DUPLICATE_CACHE_SIZE: u32 = 200;
...
pub type system_event_id_t = crate::binary::c_types::c_uint;
#[doc = " Argument structure for WIFI_EVENT_STA_WPS_ER_FAILED event"]
...
pub struct wifi_osi_funcs_t {
    ...
    pub _read_mac: ::core::option::Option<
        unsafe extern "C" fn(mac: *mut u8, type_: u32) -> crate::binary::c_types::c_int,
    >,
