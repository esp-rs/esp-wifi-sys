...
pub const CONFIG_SOC_GDMA_PAIRS_PER_GROUP: u32 = 1;
...
pub const CONFIG_SOC_I2C_FIFO_LEN: u32 = 16;
...
pub const CONFIG_SOC_MEMSPI_SRC_FREQ_60M_SUPPORTED: u32 = 1;
pub const CONFIG_SOC_MEMSPI_SRC_FREQ_30M_SUPPORTED: u32 = 1;
pub const CONFIG_SOC_MEMSPI_SRC_FREQ_20M_SUPPORTED: u32 = 1;
pub const CONFIG_SOC_MEMSPI_SRC_FREQ_15M_SUPPORTED: u32 = 1;
...
pub const CONFIG_SOC_TIMER_GROUPS: u32 = 1;
...
pub const CONFIG_SOC_TIMER_GROUP_SUPPORT_PLL_F40M: u32 = 1;
pub const CONFIG_SOC_TIMER_GROUP_TOTAL_TIMERS: u32 = 1;
...
pub const CONFIG_IDF_TARGET: &[u8; 8usize] = b"esp32c2\0";
...
pub const CONFIG_ESPTOOLPY_FLASHFREQ: &[u8; 4usize] = b"60m\0";
...
pub const CONFIG_BT_LE_ACL_BUF_COUNT: u32 = 24;
pub const CONFIG_BT_LE_ACL_BUF_SIZE: u32 = 255;
...
pub const CONFIG_ESP32C2_REV_MAX_FULL: u32 = 199;
...
pub const CONFIG_MMU_PAGE_MODE: &[u8; 5usize] = b"32KB\0";
...
pub const CONFIG_ESP32C2_MMU_PAGE_SIZE_64KB: u32 = 1;
pub const CONFIG_ESP32C2_MMU_PAGE_MODE: u32 = 2;
...
pub const NIMBLE_LL_STACK_SIZE: u32 = 4096;
...
pub const DEFAULT_BT_LE_MAX_CONNECTIONS: u32 = 2;
pub const DEFAULT_BT_LE_ACL_BUF_SIZE: u32 = 255;
pub const DEFAULT_BT_LE_ACL_BUF_COUNT: u32 = 24;
...
pub const HCI_UART_EN: u32 = 0;
pub const NIMBLE_SLEEP_ENABLE: u32 = 0;
...
pub const DEFAULT_BT_LE_HCI_UART_TX_PIN: u32 = 0;
pub const DEFAULT_BT_LE_HCI_UART_RX_PIN: u32 = 0;
pub const DEFAULT_BT_LE_HCI_UART_PORT: u32 = 0;
pub const DEFAULT_BT_LE_HCI_UART_BAUD: u32 = 0;
pub const DEFAULT_BT_LE_HCI_UART_DATA_BITS: u32 = 0;
pub const DEFAULT_BT_LE_HCI_UART_STOP_BITS: u32 = 0;
pub const DEFAULT_BT_LE_HCI_UART_PARITY: u32 = 0;
pub const DEFAULT_BT_LE_HCI_UART_TASK_STACK_SIZE: u32 = 0;
pub const DEFAULT_BT_LE_HCI_UART_FLOW_CTRL: u32 = 0;
...
pub const RTC_FREQ_N: u32 = 32000;
...
pub const CONFIG_VERSION: u32 = 539101220;
...
pub type ble_npl_error = crate::binary::c_types::c_uint;
...
pub struct ble_npl_event {
    pub dummy: crate::binary::c_types::c_int,
}
#[repr(C)]
#[derive(Copy, Clone)]
...
extern "C" {
    pub fn ble_npl_get_current_task_id() -> *mut crate::binary::c_types::c_void;
}
extern "C" {
...
extern "C" {
    pub fn ble_npl_event_get_arg(ev: *mut ble_npl_event) -> *mut crate::binary::c_types::c_void;
}
extern "C" {
    pub fn ble_npl_event_set_arg(ev: *mut ble_npl_event, arg: *mut crate::binary::c_types::c_void);
}
extern "C" {
...
extern "C" {
    pub fn ble_npl_callout_init(
        ...
        ev_arg: *mut crate::binary::c_types::c_void,
    ) -> crate::binary::c_types::c_int;
}
extern "C" {
...
extern "C" {
    pub fn ble_npl_callout_set_arg(
        co: *mut ble_npl_callout,
        arg: *mut crate::binary::c_types::c_void,
    );
}
...
pub type esp_ble_enhanced_power_type_t = crate::binary::c_types::c_uint;
#[repr(C)]
#[derive(Copy, Clone)]
...
extern "C" {
    ...
    #[doc = "         Connection Tx power should only be set after connection created."]
    #[doc = " @param  power_type : The enhanced type of which tx power, could set Advertising/Connection/Default and etc"]
    #[doc = " @param  handle : The handle of Advertising or Connection and the value 0 for other enhanced power types."]
    #[doc = " @param  power_level: Power level(index) corresponding to absolute value(dbm)"]
    #[doc = " @return              ESP_OK - success, other - failed"]
...
extern "C" {
    pub fn esp_ble_hw_get_static_addr(addr: *mut esp_ble_addr_t) -> crate::binary::c_types::c_int;
}
