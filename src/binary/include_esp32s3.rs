...
pub const CONFIG_SOC_GDMA_SUPPORT_PSRAM: u32 = 1;
pub const CONFIG_SOC_GDMA_PSRAM_MIN_ALIGN: u32 = 16;
...
pub const CONFIG_SOC_USB_PERIPH_NUM: u32 = 1;
...
pub const CONFIG_SOC_SPI_MEM_SUPPORT_TIME_TUNING: u32 = 1;
...
pub const CONFIG_IDF_TARGET: &[u8; 8usize] = b"esp32s3\0";
...
pub const CONFIG_BT_CTRL_DFT_TX_POWER_LEVEL_EFF: u32 = 9;
...
pub const ESP_BT_CTRL_CONFIG_VERSION: u32 = 34677376;
...
pub const BLE_HW_TARGET_CODE_ESP32S3_CHIP_ECO0: u32 = 33619968;
...
#[doc = "< Internal 90kHz RC oscillator"]
...
pub type esp_bt_hci_tl_callback_t = ::core::option::Option<
    unsafe extern "C" fn(arg: *mut crate::binary::c_types::c_void, status: u8),
>;
