...
bindgen %OPTS% include\include.h > src\binary\include_esp32c3.rs -- -I./headers/ -I%INCL% -I./include/ -DCONFIG_IDF_TARGET_ESP32C3
set INCL=\Users\Bjoern\.espressif\tools\xtensa-esp32-elf\esp-2021r2-8.4.0\xtensa-esp32-elf\xtensa-esp32-elf\include
bindgen %OPTS% include\include.h > src\binary\include_esp32.rs -- -I./headers/ -I%INCL% -I./include/ -DCONFIG_IDF_TARGET_ESP32
