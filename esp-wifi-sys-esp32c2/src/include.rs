...
pub const CONFIG_SOC_EFUSE_CONSISTS_OF_ONE_KEY_BLOCK: u32 = 1;
...
pub const CONFIG_SOC_ECC_SUPPORT_POINT_VERIFY_QUIRK: u32 = 1;
pub const CONFIG_SOC_AHB_GDMA_VERSION: u32 = 1;
pub const CONFIG_SOC_GPIO_PORT: u32 = 1;
pub const CONFIG_SOC_GPIO_PIN_COUNT: u32 = 21;
...
pub const CONFIG_SOC_GPIO_IN_RANGE_MAX: u32 = 20;
pub const CONFIG_SOC_GPIO_OUT_RANGE_MAX: u32 = 20;
pub const CONFIG_SOC_GPIO_HP_PERIPH_PD_SLEEP_WAKEABLE_MASK: u32 = 0;
pub const CONFIG_SOC_GPIO_VALID_DIGITAL_IO_PAD_MASK: u32 = 2097088;
...
pub const CONFIG_SOC_PHY_IMPROVE_RX_11B: u32 = 1;
...
pub const CONFIG_IDF_TARGET: &[u8; 8] = b"esp32c2\0";
pub const CONFIG_IDF_INIT_VERSION: &[u8; 6] = b"6.1.0\0";
pub const CONFIG_IDF_TARGET_ESP32C2: u32 = 1;
pub const CONFIG_IDF_FIRMWARE_CHIP_ID: u32 = 12;
...
pub const CONFIG_ESP_ROM_HAS_MBEDTLS_CRYPTO_LIB: u32 = 1;
...
pub const CONFIG_ESPTOOLPY_FLASHFREQ_60M: u32 = 1;
pub const CONFIG_ESPTOOLPY_FLASHFREQ: &[u8; 4] = b"60m\0";
...
pub const CONFIG_BT_ACL_CONNECTIONS: u32 = 2;
...
pub const CONFIG_BT_LE_EXT_SCAN: u32 = 1;
pub const CONFIG_BT_LE_ENABLE_PERIODIC_SYNC: u32 = 1;
...
pub const CONFIG_BT_LE_MAX_CONNECTIONS: u32 = 2;
...
pub const CONFIG_BT_LE_RELEASE_IRAM_SUPPORTED: u32 = 1;
pub const CONFIG_BT_LE_FEAT_LL_ENCRYPTION: u32 = 1;
pub const CONFIG_BT_LE_ROLE_CENTROL_ENABLE: u32 = 1;
pub const CONFIG_BT_LE_ROLE_PERIPHERAL_ENABLE: u32 = 1;
pub const CONFIG_BT_LE_ROLE_BROADCASTER_ENABLE: u32 = 1;
pub const CONFIG_BT_LE_ROLE_OBSERVER_ENABLE: u32 = 1;
...
pub const CONFIG_ESP32C2_REV_MIN_1: u32 = 1;
pub const CONFIG_ESP32C2_REV_MIN_FULL: u32 = 100;
pub const CONFIG_ESP_REV_MIN_FULL: u32 = 100;
pub const CONFIG_ESP32C2_REV_MAX_FULL: u32 = 299;
pub const CONFIG_ESP_REV_MAX_FULL: u32 = 299;
...
pub const CONFIG_ESP32C2_UNIVERSAL_MAC_ADDRESSES_FOUR: u32 = 1;
pub const CONFIG_ESP32C2_UNIVERSAL_MAC_ADDRESSES: u32 = 4;
...
pub const CONFIG_ESP_DEFAULT_CPU_FREQ_MHZ_120: u32 = 1;
pub const CONFIG_ESP_DEFAULT_CPU_FREQ_MHZ: u32 = 120;
...
pub const CONFIG_ESP_TASK_WDT_USE_ESP_TIMER: u32 = 1;
...
pub const CONFIG_ESP_TIMER_SUPPORTS_ISR_DISPATCH_METHOD: u32 = 1;
...
pub const CONFIG_ESP_WIFI_ESPNOW_MAX_ENCRYPT_NUM: u32 = 2;
pub const CONFIG_ESP_WIFI_ENTERPRISE_SUPPORT: u32 = 1;
pub const CONFIG_ESP_WIFI_ENT_FREE_DYNAMIC_BUFFER: u32 = 1;
...
pub const ESP_WIFI_MAX_CONN_NUM: u32 = 4;
...
pub const _SOC_CAPS_TARGET_IS_ESP32C2: u32 = 1;
...
pub const SOC_EFUSE_KEY_PURPOSE_FIELD: u32 = 0;
pub const SOC_EFUSE_CONSISTS_OF_ONE_KEY_BLOCK: u32 = 1;
...
pub const SOC_ECC_SUPPORT_POINT_VERIFY_QUIRK: u32 = 1;
pub const SOC_AHB_GDMA_VERSION: u32 = 1;
pub const SOC_GPIO_PORT: u32 = 1;
pub const SOC_GPIO_PIN_COUNT: u32 = 21;
...
pub const SOC_GPIO_VALID_GPIO_MASK: u32 = 2097151;
pub const SOC_GPIO_VALID_OUTPUT_GPIO_MASK: u32 = 2097151;
pub const SOC_GPIO_IN_RANGE_MAX: u32 = 20;
pub const SOC_GPIO_OUT_RANGE_MAX: u32 = 20;
pub const SOC_GPIO_VALID_DIGITAL_IO_PAD_MASK: u32 = 2097088;
...
pub const SOC_FLASH_ENCRYPTION_XTS_AES_128_DERIVED: u32 = 1;
pub const SOC_UART_NUM: u32 = 2;
pub const SOC_UART_HP_NUM: u32 = 2;
pub const SOC_UART_FIFO_LEN: u32 = 128;
pub const SOC_UART_BITRATE_MAX: u32 = 2500000;
pub const SOC_UART_SUPPORT_WAKEUP_INT: u32 = 1;
pub const SOC_UART_SUPPORT_PLL_F40M_CLK: u32 = 1;
...
pub const SOC_BLE_MESH_SUPPORTED: u32 = 0;
...
#[doc = "!< Callback is dispatched from interrupt handler"]
pub const esp_timer_dispatch_t_ESP_TIMER_ISR: esp_timer_dispatch_t = 1;
#[doc = "!< Sentinel value for the number of callback dispatch methods"]
pub const esp_timer_dispatch_t_ESP_TIMER_MAX: esp_timer_dispatch_t = 2;
...
pub const periph_interrupt_t_ETS_LP_TIMER_SOURCE: periph_interrupt_t = 7;
#[doc = "< interrupt of RWBLE, level"]
pub const periph_interrupt_t_ETS_COEX_SOURCE: periph_interrupt_t = 8;
#[doc = "< interrupt of RWBT, NMI, use if RWBT have bug to fix in NMI"]
pub const periph_interrupt_t_ETS_BLE_TIMER_SOURCE: periph_interrupt_t = 9;
#[doc = "< interrupt of RWBLE, NMI, use if RWBT have bug to fix in NMI"]
pub const periph_interrupt_t_ETS_BLE_SEC_SOURCE: periph_interrupt_t = 10;
...
pub const periph_interrupt_t_ETS_APB_CTRL_INTR_SOURCE: periph_interrupt_t = 12;
#[doc = "< interrupt of GPIO, level"]
pub const periph_interrupt_t_ETS_GPIO_INTR_SOURCE: periph_interrupt_t = 13;
#[doc = "< interrupt of GPIO, NMI"]
pub const periph_interrupt_t_ETS_GPIO_NMI_SOURCE: periph_interrupt_t = 14;
#[doc = "< interrupt of SPI1, level, SPI1 is for flash read/write, do not use this"]
pub const periph_interrupt_t_ETS_SPI1_INTR_SOURCE: periph_interrupt_t = 15;
#[doc = "< interrupt of SPI2, level"]
pub const periph_interrupt_t_ETS_SPI2_INTR_SOURCE: periph_interrupt_t = 16;
#[doc = "< interrupt of UART0, level"]
pub const periph_interrupt_t_ETS_UART0_INTR_SOURCE: periph_interrupt_t = 17;
#[doc = "< interrupt of UART1, level"]
pub const periph_interrupt_t_ETS_UART1_INTR_SOURCE: periph_interrupt_t = 18;
#[doc = "< interrupt of LED PWM, level"]
pub const periph_interrupt_t_ETS_LEDC_INTR_SOURCE: periph_interrupt_t = 19;
#[doc = "< interrupt of efuse, level, not likely to use"]
pub const periph_interrupt_t_ETS_EFUSE_INTR_SOURCE: periph_interrupt_t = 20;
#[doc = "< interrupt of rtc core, level, include rtc watchdog"]
pub const periph_interrupt_t_ETS_RTC_CORE_INTR_SOURCE: periph_interrupt_t = 21;
#[doc = "< interrupt of I2C controller1, level"]
pub const periph_interrupt_t_ETS_I2C_EXT0_INTR_SOURCE: periph_interrupt_t = 22;
#[doc = "< interrupt of TIMER_GROUP0, TIMER0, level"]
pub const periph_interrupt_t_ETS_TG0_T0_LEVEL_INTR_SOURCE: periph_interrupt_t = 23;
#[doc = "< interrupt of TIMER_GROUP0, WATCH DOG, level"]
pub const periph_interrupt_t_ETS_TG0_WDT_LEVEL_INTR_SOURCE: periph_interrupt_t = 24;
#[doc = "< interrupt of Cache Invalid Access, LEVEL"]
pub const periph_interrupt_t_ETS_CACHE_IA_INTR_SOURCE: periph_interrupt_t = 25;
#[doc = "< interrupt of system timer 0"]
pub const periph_interrupt_t_ETS_SYSTIMER_TARGET0_INTR_SOURCE: periph_interrupt_t = 26;
#[doc = "< interrupt of system timer 1"]
pub const periph_interrupt_t_ETS_SYSTIMER_TARGET1_INTR_SOURCE: periph_interrupt_t = 27;
#[doc = "< interrupt of system timer 2"]
pub const periph_interrupt_t_ETS_SYSTIMER_TARGET2_INTR_SOURCE: periph_interrupt_t = 28;
#[doc = "< use ETS_SYSTIMER_TARGET0_INTR_SOURCE"]
pub const periph_interrupt_t_ETS_SYSTIMER_TARGET0_EDGE_INTR_SOURCE: periph_interrupt_t = 26;
#[doc = "< use ETS_SYSTIMER_TARGET1_INTR_SOURCE"]
pub const periph_interrupt_t_ETS_SYSTIMER_TARGET1_EDGE_INTR_SOURCE: periph_interrupt_t = 27;
#[doc = "< use ETS_SYSTIMER_TARGET2_INTR_SOURCE"]
pub const periph_interrupt_t_ETS_SYSTIMER_TARGET2_EDGE_INTR_SOURCE: periph_interrupt_t = 28;
#[doc = "< interrupt of SPI0 Cache access and SPI1 access rejected, LEVEL"]
pub const periph_interrupt_t_ETS_SPI_MEM_REJECT_CACHE_INTR_SOURCE: periph_interrupt_t = 29;
#[doc = "< interrupt of ICache perload operation, LEVEL"]
pub const periph_interrupt_t_ETS_ICACHE_PRELOAD0_INTR_SOURCE: periph_interrupt_t = 30;
#[doc = "< interrupt of instruction cache sync done, LEVEL"]
pub const periph_interrupt_t_ETS_ICACHE_SYNC0_INTR_SOURCE: periph_interrupt_t = 31;
#[doc = "< interrupt of APB ADC, LEVEL"]
pub const periph_interrupt_t_ETS_APB_ADC_INTR_SOURCE: periph_interrupt_t = 32;
#[doc = "< interrupt of general DMA channel 0, LEVEL"]
pub const periph_interrupt_t_ETS_DMA_CH0_INTR_SOURCE: periph_interrupt_t = 33;
#[doc = "< interrupt of SHA accelerator, level"]
pub const periph_interrupt_t_ETS_SHA_INTR_SOURCE: periph_interrupt_t = 34;
#[doc = "< interrupt of ECC accelerator, level"]
pub const periph_interrupt_t_ETS_ECC_INTR_SOURCE: periph_interrupt_t = 35;
#[doc = "< interrupt0 generated from a CPU, level"]
pub const periph_interrupt_t_ETS_FROM_CPU_INTR0_SOURCE: periph_interrupt_t = 36;
#[doc = "< interrupt1 generated from a CPU, level"]
pub const periph_interrupt_t_ETS_FROM_CPU_INTR1_SOURCE: periph_interrupt_t = 37;
#[doc = "< interrupt2 generated from a CPU, level"]
pub const periph_interrupt_t_ETS_FROM_CPU_INTR2_SOURCE: periph_interrupt_t = 38;
#[doc = "< interrupt3 generated from a CPU, level"]
pub const periph_interrupt_t_ETS_FROM_CPU_INTR3_SOURCE: periph_interrupt_t = 39;
#[doc = "< interrupt of Assist debug module, LEVEL"]
pub const periph_interrupt_t_ETS_ASSIST_DEBUG_INTR_SOURCE: periph_interrupt_t = 40;
pub const periph_interrupt_t_ETS_CORE0_PIF_PMS_SIZE_INTR_SOURCE: periph_interrupt_t = 41;
pub const periph_interrupt_t_ETS_CACHE_CORE0_ACS_INTR_SOURCE: periph_interrupt_t = 42;
pub const periph_interrupt_t_ETS_MAX_INTR_SOURCE: periph_interrupt_t = 43;
pub type periph_interrupt_t = crate::c_types::c_uint;
extern "C" {
    pub static esp_isr_names: [*const crate::c_types::c_char; 43usize];
}
pub const shared_periph_module_t_PERIPH_TIMG0_MODULE: shared_periph_module_t = 0;
pub const shared_periph_module_t_PERIPH_UHCI0_MODULE: shared_periph_module_t = 1;
pub const shared_periph_module_t_PERIPH_RNG_MODULE: shared_periph_module_t = 2;
...
pub const shared_periph_module_t_PERIPH_WIFI_BT_COMMON_MODULE: shared_periph_module_t = 5;
pub const shared_periph_module_t_PERIPH_SYSTIMER_MODULE: shared_periph_module_t = 6;
pub const shared_periph_module_t_PERIPH_PHY_CALIBRATION_MODULE: shared_periph_module_t = 7;
pub const shared_periph_module_t_PERIPH_COEX_MODULE: shared_periph_module_t = 8;
pub const shared_periph_module_t_PERIPH_MODULE_MAX: shared_periph_module_t = 9;
...
#[doc = "< Corresponding to  +20 dBm, this enum variable has been deprecated"]
...
extern "C" {
    #[doc = " @brief Get version number from chip revision number\n\n @return uint8_t version_number"]
    pub fn esp_ble_get_chip_rev_version() -> u8;
}
