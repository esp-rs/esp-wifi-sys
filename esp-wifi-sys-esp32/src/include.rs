...
pub const CONFIG_SOC_I2S_I80_LCD_SUPPORTED: u32 = 1;
...
pub const CONFIG_SOC_ADC_SAMPLE_FREQ_THRES_HIGH: u32 = 2000000;
pub const CONFIG_SOC_ADC_SAMPLE_FREQ_THRES_LOW: u32 = 20000;
...
pub const CONFIG_SOC_RTC_CNTL_NEEDS_ATOMIC_ACCESS: u32 = 1;
...
pub const CONFIG_SOC_PM_RTC_NOT_SUPPORT_UART2_WAKEUP: u32 = 1;
...
pub const CONFIG_SOC_SDMMC_DATA_WIDTH_MAX: u32 = 8;
...
pub const CONFIG_SOC_EMAC_REF_CLK_FROM_APLL: u32 = 1;
...
pub const CONFIG_ESP_ROM_HAS_REGI2C_IMPL: u32 = 1;
pub const CONFIG_ESP_ROM_BOOTLOADER_OFFSET_FLASH: u32 = 4096;
...
pub const CONFIG_BT_BLE_42_FEATURES_SUPPORTED: u32 = 1;
pub const CONFIG_BT_BLE_42_DTM_TEST_EN: u32 = 1;
pub const CONFIG_BT_BLE_42_ADV_EN: u32 = 1;
pub const CONFIG_BT_BLE_42_SCAN_EN: u32 = 1;
...
pub const CONFIG_BTDM_CTRL_PCM_FSYNCSHP_EFF: u32 = 0;
pub const CONFIG_BTDM_CTRL_BLE_MAX_CONN_EFF: u32 = 3;
pub const CONFIG_BTDM_CTRL_BR_EDR_MIN_ENC_KEY_SZ_DFT_EFF: u32 = 0;
...
pub const CONFIG_BTDM_BLE_CHAN_ASS_EN: u32 = 1;
pub const CONFIG_BTDM_BLE_PING_EN: u32 = 1;
...
pub const CONFIG_HEAP_HAS_EXEC_HEAP: u32 = 1;
...
pub const _SOC_CAPS_TARGET_IS_ESP32: u32 = 1;
...
pub const SOC_I2S_I80_LCD_SUPPORTED: u32 = 1;
...
pub const SOC_RTC_CNTL_NEEDS_ATOMIC_ACCESS: u32 = 1;
...
pub const SOC_RTC_TIMER_V1: u32 = 1;
...
pub const SOC_PM_RTC_NOT_SUPPORT_UART2_WAKEUP: u32 = 1;
...
pub const SOC_SDMMC_DATA_WIDTH_MAX: u32 = 8;
...
pub const SOC_EMAC_REF_CLK_FROM_APLL: u32 = 1;
...
pub const ESP_BT_CONTROLLER_CONFIG_MAGIC_VAL: u32 = 539296536;
...
pub const BTDM_CTRL_SCAN_BACKOFF_UPPERLIMITMAX: u32 = 0;
pub const BTDM_BLE_LLCP_CONN_UPDATE: u32 = 0;
pub const BTDM_BLE_LLCP_CHAN_MAP_UPDATE: u32 = 0;
pub const BTDM_BLE_LLCP_DISC_FLAG: u32 = 0;
pub const BTDM_CTRL_CHECK_CONNECT_IND_ACCESS_ADDRESS_ENABLED: u32 = 0;
pub const BTDM_BLE_CHAN_ASS_EN: u32 = 1;
pub const BTDM_CTRL_CONTROLLER_DEBUG_MODE_1: u32 = 0;
pub const BTDM_CTRL_CONTROLLER_DEBUG_FLAG: u32 = 0;
pub const BTDM_BLE_PING_EN: u32 = 1;
...
#[doc = "< Bluetooth is not operating."]
pub const esp_bt_mode_t_ESP_BT_MODE_IDLE: esp_bt_mode_t = 0;
#[doc = "< Bluetooth is operating in BLE mode."]
pub const esp_bt_mode_t_ESP_BT_MODE_BLE: esp_bt_mode_t = 1;
#[doc = "< Bluetooth is operating in Classic Bluetooth mode."]
pub const esp_bt_mode_t_ESP_BT_MODE_CLASSIC_BT: esp_bt_mode_t = 2;
#[doc = "< Bluetooth is operating in Dual mode."]
pub const esp_bt_mode_t_ESP_BT_MODE_BTDM: esp_bt_mode_t = 3;
#[doc = " @brief Bluetooth Controller mode"]
pub type esp_bt_mode_t = crate::c_types::c_uint;
#[doc = "< BLE SCA at 500 ppm"]
pub const esp_ble_sca_t_ESP_BLE_SCA_500PPM: esp_ble_sca_t = 0;
#[doc = "< BLE SCA at 250 ppm"]
pub const esp_ble_sca_t_ESP_BLE_SCA_250PPM: esp_ble_sca_t = 1;
#[doc = "< BLE SCA at 150 ppm"]
pub const esp_ble_sca_t_ESP_BLE_SCA_150PPM: esp_ble_sca_t = 2;
#[doc = "< BLE SCA at 100 ppm"]
pub const esp_ble_sca_t_ESP_BLE_SCA_100PPM: esp_ble_sca_t = 3;
#[doc = "< BLE SCA at 75 ppm"]
pub const esp_ble_sca_t_ESP_BLE_SCA_75PPM: esp_ble_sca_t = 4;
#[doc = "< BLE SCA at 50 ppm"]
pub const esp_ble_sca_t_ESP_BLE_SCA_50PPM: esp_ble_sca_t = 5;
#[doc = "< BLE SCA at 30 ppm"]
pub const esp_ble_sca_t_ESP_BLE_SCA_30PPM: esp_ble_sca_t = 6;
#[doc = "< BLE SCA at 20 ppm"]
pub const esp_ble_sca_t_ESP_BLE_SCA_20PPM: esp_ble_sca_t = 7;
#[doc = " @brief BLE sleep clock accuracy (SCA)\n\n @note Currently only ESP_BLE_SCA_500PPM and ESP_BLE_SCA_250PPM are supported."]
...
pub struct esp_bt_controller_config_t {
    ...
    #[doc = "< UART number as HCI I/O interface. Configurable in menuconfig.\n- 1 - URAT 1 (default)\n- 2 - URAT 2"]
    pub hci_uart_no: u8,
    #[doc = "<  UART baudrate. Configurable in menuconfig.\n- Range: 115200 - 921600\n- Default: 921600"]
    pub hci_uart_baudrate: u32,
    #[doc = "< Scan duplicate filtering mode. Configurable in menuconfig.\n- 0 - Normal scan duplicate filtering mode (default)\n- 1 - Special scan duplicate filtering mode for BLE Mesh"]
    pub scan_duplicate_mode: u8,
    #[doc = "< Scan duplicate filtering type. If `scan_duplicate_mode` is set to 1, this parameter will be ignored. Configurable in menuconfig.\n- 0 - Filter scan duplicates by device address only (default)\n- 1 - Filter scan duplicates by advertising data only, even if they originate from different devices.\n- 2 - Filter scan duplicated by device address and advertising data."]
    pub scan_duplicate_type: u8,
    #[doc = "< Maximum number of devices in scan duplicate filtering list. Configurable in menuconfig\n- Range: 10 - 1000\n- Default: 100"]
    pub normal_adv_size: u16,
    #[doc = "< Maximum number of Mesh advertising packets in scan duplicate filtering list. Configurable in menuconfig\n- Range: 10 - 1000\n- Default: 100"]
    pub mesh_adv_size: u16,
    #[doc = "< Controller minimum memory value in bytes. Internal use only"]
    pub send_adv_reserved_size: u16,
    #[doc = "< Controller debug log flag. Internal use only"]
    pub controller_debug_flag: u32,
    #[doc = "< Controller mode.  Configurable in menuconfig\n- 1 - BLE mode\n- 2 - Classic Bluetooth mode\n- 3 - Dual mode\n- 4 - Others: Invalid"]
    pub mode: u8,
    #[doc = "< Maximum number of BLE connections. Configurable in menuconfig\n- Range: 1 - 9\n- Default: 3"]
    pub ble_max_conn: u8,
    #[doc = "< Maximum number of BR/EDR ACL connections. Configurable in menuconfig\n- Range: 1 - 7\n- Default: 2"]
    pub bt_max_acl_conn: u8,
    #[doc = "< SCO data path. Configurable in menuconfig\n- 0 - HCI module (default)\n- 1 - PCM module"]
    pub bt_sco_datapath: u8,
    #[doc = "< True if BLE auto latency is enabled, used to enhance Classic Bluetooth performance in the Dual mode; false otherwise (default). Configurable in menuconfig"]
    pub auto_latency: bool,
    #[doc = "< True if BR/EDR Legacy Authentication Vendor Specific Event is enabled (default in the classic bluetooth or Dual mode), which is required to protect from BIAS attack; false otherwise. Configurable in menuconfig"]
    ...
    #[doc = "< BLE low power crystal accuracy index. Configurable in menuconfig\n- 0 - `BTDM_BLE_DEFAULT_SCA_500PPM`\n- 1 - `BTDM_BLE_DEFAULT_SCA_250PPM` (default)"]
    pub ble_sca: u8,
    #[doc = "< PCM role. Configurable in menuconfig\n- 0 - PCM master (default)\n- 1 - PCM slave (default)"]
    pub pcm_role: u8,
    #[doc = "< PCM polarity (falling clk edge & rising clk edge). Configurable in menuconfig\n- 0 - Falling Edge (default)\n- 1 - Rising Edge"]
    pub pcm_polar: u8,
    #[doc = "< Physical shape of the PCM Frame Synchronization signal. Configurable in menuconfig\n- 0 - Stereo Mode (default)\n- 1 - Mono Mode 1\n- 2 - Mono Mode 2"]
    pub pcm_fsyncshp: u8,
    #[doc = "< True if using high-level (level 4) interrupt (default); false otherwise. Configurable in menuconfig"]
    pub hli: bool,
    #[doc = "< Minimum size of the encryption key\n- Range: 7 - 16\n- Default: 7"]
    pub enc_key_sz_min: u8,
    #[doc = "< Scan duplicate filtering list refresh period in seconds. Configurable in menuconfig\n- Range: 0 - 100 seconds\n- Default: 0 second"]
    pub dup_list_refresh_period: u16,
    #[doc = "< True if BLE scan backoff is enabled; false otherwise (default). Configurable in menuconfig"]
    pub ble_scan_backoff: bool,
...
#[doc = "< Backward compatibility! Setting to -14 dBm will actually result in -12 dBm"]
pub const esp_power_level_t_ESP_PWR_LVL_N14: esp_power_level_t = 0;
#[doc = "< Backward compatibility! Setting to -11 dBm will actually result in -9 dBm"]
pub const esp_power_level_t_ESP_PWR_LVL_N11: esp_power_level_t = 1;
#[doc = "< Backward compatibility! Setting to  -8 dBm will actually result in -6 dBm"]
pub const esp_power_level_t_ESP_PWR_LVL_N8: esp_power_level_t = 2;
#[doc = "< Backward compatibility! Setting to  -5 dBm will actually result in -3 dBm"]
pub const esp_power_level_t_ESP_PWR_LVL_N5: esp_power_level_t = 3;
#[doc = "< Backward compatibility! Setting to  -2 dBm will actually result in 0 dBm"]
pub const esp_power_level_t_ESP_PWR_LVL_N2: esp_power_level_t = 4;
#[doc = "< Backward compatibility! Setting to  +1 dBm will actually result in +3 dBm"]
pub const esp_power_level_t_ESP_PWR_LVL_P1: esp_power_level_t = 5;
#[doc = "< Backward compatibility! Setting to  +4 dBm will actually result in +6 dBm"]
pub const esp_power_level_t_ESP_PWR_LVL_P4: esp_power_level_t = 6;
#[doc = "< Backward compatibility! Setting to  +7 dBm will actually result in +9 dBm"]
pub const esp_power_level_t_ESP_PWR_LVL_P7: esp_power_level_t = 7;
#[doc = " @brief Bluetooth TX power level (index). Each index corresponds to a specific power value in dBm."]
...
#[doc = "< External 32.768kHz crystal/oscillator"]
...
pub struct esp_vhci_host_callback {
    ...
    #[doc = "< Callback to notify the Host that the Controller has the HCI data to send"]
